...
[DHIS2 App Store.](https://play.dhis2.org/appstore/)  It is currently compatible
with DHIS2 2.28 and above. 

![Figure 1.1-A: Standard layout of the Action Tracker dashboard](/img/bna-action-tracker/image01.png)
...
## Accessing the Linked Action Tracker
...
accessed on: [Data Use Apps Demo](https://data-use-apps.hisptz.com/demo)
with the username and password provided on the login page.

![Figure 1.4-A: Logging and accessing the Action Tracker demo server](/img/bna-action-tracker/image02.png)
