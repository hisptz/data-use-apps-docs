...
![Figure 5.1-B: Google chrome interface for clearing browser cache](/img/bna-action-tracker/image37.png)
...
![Figure 5.1-C: Mozilla firefox interface for clearing browser cache](/img/bna-action-tracker/image38.png)